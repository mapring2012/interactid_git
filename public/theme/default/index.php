...
a.oPreviousSearch,c=a.oLanguage.sSearch,c=-1!==c.indexOf("_INPUT_")?c.replace("_INPUT_",'<input type="text" />'):""===c?'<input type="text" />':c+' <input type="text"  placeholder="<?php echo $this->translate("typeToFilter"); ?>" /><div class="srch"></div>',d=l.createElement("div");d.className=a.oClasses.sFilter;d.innerHTML="<label>"+c+"</label>";if(!a.aanFeatures.f)d.id=a.sTableId+"_filter";c=h('input[type="text"]',d);d._DT_Input=c[0];c.val(b.sSearch.replace('"',"&quot;"));c.bind("keyup.DT",function(){for(var c=a.aanFeatures.f,d=""===this.value?"":this.value,i=0,e=c.length;i<e;i++)c[i]!=
...
b])}function oa(a){var b=j.defaults.oLanguage;!a.sEmptyTable&&a.sZeroRecords&&"<?php echo $this->translate('nodata') ?>"===b.sEmptyTable&&p(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&a.sZeroRecords&&"Loading..."===b.sLoadingRecords&&p(a,a,"sZeroRecords","sLoadingRecords")}function ya(a){if(a.oScroll.bInfinite)return null;var b='<select size="1" '+('name="'+a.sTableId+'_length"')+">",c,d,f=a.aLengthMenu;if(2==f.length&&"object"===typeof f[0]&&"object"===typeof f[1])for(c=0,d=f[0].length;c<d;c++)b+='<option value="'+
...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"<?php echo $this->translate('first')?>",sLast:"<?php echo $this->translate('last')?>",sNext:"<?php echo $this->translate('next')?>",sPrevious:"<?php echo $this->translate('previous')?>"},sEmptyTable:"<?php echo $this->translate('nodata') ?>",sInfo:"<?php echo $this->translate('showing')?> _START_ <?php echo $this->translate('to')?> _END_ <?php echo $this->translate('of')?> _TOTAL_ <?php echo $this->translate('entry')?>",sInfoEmpty:"<?php echo $this->translate('showingOf0To0')?>",sInfoFiltered:"(<?php echo $this->translate('filteredFrom')?> _MAX_ <?php echo $this->translate('totalEntry')?>)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"<span class='showentries'><?php echo $this->translate('showT')?>:</span> _MENU_ ",sLoadingRecords:"<?php echo $this->translate('loadingT')?>",sProcessing:"<?php echo $this->translate('proccessingT')?>",sSearch:"<span><?php echo $this->translate('searchT')?>:</span>",sUrl:"",sZeroRecords:"<?php echo $this->translate('noMatching')?>"},
...
<?php
if(!empty($javascriptbotton))
{
    echo $javascriptbotton; 
}
?>
